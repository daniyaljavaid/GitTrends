package com.dj.gittrends.data.local.database
...
import com.dj.gittrends.data.local.typeconverter.ListConverter
import com.dj.gittrends.data.local.typeconverter.OwnerConverter
